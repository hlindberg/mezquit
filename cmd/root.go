...
import (
	...
	"github.com/hlindberg/mezquit/internal/check"
...
var RootCmd = &cobra.Command{
	Use:   "mezquit",
	Short: "Exploration of NATS and MQTT",
	Long: `Exploring using MQTT with NATS
  `,
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".mezquit" (without extension).
